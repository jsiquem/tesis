...
% El Manual Técnico corresponde al Apéndice B.
% Se avanza la sección para que las figuras y tablas comiencen en B1.
...
\phantomsection
\addcontentsline{toc}{section}{Apéndice B Manual Técnico}
\subsection{Manual Técnico}\label{ap:manual_tecnico}
\begin{center}
\vspace*{2cm}
