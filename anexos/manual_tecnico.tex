...
% Carátula del Manual Técnico (sin reiniciar el número de página)
\begin{center}
\subsection{Manual Técnico}\label{Manual-Tecnico}
\vspace*{1.5cm}
...
\begin{xltabular}{\linewidth}{
    ...
    \caption{Responsabilidad técnica por módulo funcional} \label{tab:B_modulos_funcionales} \\
    \toprule
...
\subsection{Reglas contables y de integridad}
...
\subsection{API y autenticación}
...
\subsection{Mantenimiento preventivo y correctivo}
...
\subsection{Matriz mínima de pruebas técnicas}
...
\begin{xltabular}{\linewidth}{
    ...
    \caption{Matriz de pruebas funcionales y técnicas} \label{tab:B_matriz_pruebas} \\
    \toprule
...
\subsection{Acceso e instalación}
...
\subsection{Configuración por ambientes}
...
\subsection{Lista de verificación de mantenimiento}
...
\subsection{Pruebas técnicas mínimas}
