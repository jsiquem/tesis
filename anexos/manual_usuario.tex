...
\phantomsection
\addcontentsline{toc}{subsection}{Apéndice A, Manual de usuario}
\subsection*{Apéndice A Manual de Usuario}\label{ap:Manual-de-Usuario}
\begin{center}
\vspace*{2cm}
...
En la sección de acceso, siga los pasos ilustrados en la captura actual para ingresar al sistema.
...
\begin{figure}[H]
    \centering
    \caption{Pantalla de acceso actual.}
    \label{fig:manual_usuario_pantalla_01_login_anotada}
    \includegraphics[width=0.92\linewidth]{capturas_reales/angular_actualizadas/pantalla_01_login.png}
\end{figure}
...
Las instrucciones siguientes describen las operaciones principales del sistema mediante capturas actuales. Realice cada paso en el orden indicado y verifique el mensaje mostrado antes de continuar.
...
\begin{figure}[H]
    \centering
    \caption{Panel principal actual.}
    \label{fig:manual_usuario_pantalla_02_dashboard_anotada}
    \includegraphics[width=0.92\linewidth]{capturas_reales/angular_actualizadas/pantalla_02_dashboard.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Módulo de Facturas FEL/SAT actual.}
    \label{fig:manual_usuario_pantalla_03_facturas_fel_anotada}
    \includegraphics[width=0.92\linewidth]{capturas_reales/angular_actualizadas/pantalla_03_facturas_fel.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Módulo de Cheques actual.}
    \label{fig:manual_usuario_pantalla_04_cheques_anotada}
    \includegraphics[width=0.92\linewidth]{capturas_reales/angular_actualizadas/formulario_cheque.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Módulo de Caja chica actual.}
    \label{fig:manual_usuario_pantalla_05_caja_chica_anotada}
    \includegraphics[width=0.92\linewidth]{capturas_reales/angular_actualizadas/pantalla_05_caja_chica.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Módulo de Viáticos actual.}
    \label{fig:manual_usuario_pantalla_06_viaticos_anotada}
    \includegraphics[width=0.92\linewidth]{capturas_reales/angular_actualizadas/pantalla_06_viaticos.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Pantalla de asignación de facturas actual.}
    \label{fig:manual_usuario_pantalla_07_asignacion_facturas_anotada}
    \includegraphics[width=0.92\linewidth]{capturas_reales/angular_actualizadas/pantalla_07_viaticos_nueva_liquidacion.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Módulo de Proveedores actual.}
    \label{fig:manual_usuario_pantalla_08_proveedores_anotada}
    \includegraphics[width=0.92\linewidth]{capturas_reales/angular_actualizadas/pantalla_08_proveedores_nuevo.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Módulo de Calendario actual.}
    \label{fig:manual_usuario_pantalla_09_calendario_anotada}
    \includegraphics[width=0.92\linewidth]{capturas_reales/angular_actualizadas/pantalla_09_calendario.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Módulo de Nomenclatura actual.}
    \label{fig:manual_usuario_pantalla_10_nomenclatura_anotada}
    \includegraphics[width=0.92\linewidth]{capturas_reales/angular_actualizadas/pantalla_10_nomenclatura.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Módulo de Reportes actual.}
    \label{fig:manual_usuario_pantalla_11_reportes_anotada}
    \includegraphics[width=0.92\linewidth]{capturas_reales/angular_actualizadas/pantalla_11_reportes.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Resumen de Caja chica actual.}
