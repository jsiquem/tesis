...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_01_login_anotada.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_02_dashboard_anotada.png}
    \caption*{Nota. Elaboración propia a partir del prototipo funcional.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_03_facturas_fel_anotada.png}
    \caption*{Nota. Elaboración propia a partir del prototipo funcional.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_04_cheques_anotada.png}
    \caption*{Nota. Elaboración propia a partir del prototipo funcional.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_05_caja_chica_anotada.png}
    \caption*{Nota. Elaboración propia a partir del prototipo funcional.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_06_viaticos_anotada.png}
    \caption*{Nota. Elaboración propia a partir del prototipo funcional.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_07_asignacion_facturas_anotada.png}
    \caption*{Nota. Elaboración propia a partir del prototipo funcional.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_08_proveedores_anotada.png}
    \caption*{Nota. Elaboración propia a partir del prototipo funcional.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_09_calendario_anotada.png}
    \caption*{Nota. Elaboración propia a partir del prototipo funcional.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_10_nomenclatura_anotada.png}
    \caption*{Nota. Elaboración propia a partir del prototipo funcional.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_11_reportes_anotada.png}
    \caption*{Nota. Elaboración propia a partir del prototipo funcional.}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.92\linewidth]{manual_anotadas/pantalla_12_resumen_caja_anotada.png}
    \caption*{Nota. Elaboración propia a partir del prototipo funcional.}
\end{figure}
