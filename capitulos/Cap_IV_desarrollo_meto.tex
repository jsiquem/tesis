...
\caption{Clasificación de pruebas aplicada al prototipo}\label{tab:cap4_tipos_prueba}\tabularnewline
\toprule
...
{\fontsize{9}{11}\selectfont\setstretch{1.15}\setlength{\parindent}{0pt}
...
\caption{Casos de prueba del módulo de Facturas FEL/SAT}\label{tab:cap4_pruebas_fel_actualizadas}\tabularnewline
\toprule
...
\bottomrule
\endlastfoot
FEL-01 & FEL & SIS & Acceso y disponibilidad & -- & Iniciar sesión y navegar a Facturas FEL. & El módulo carga y permite consultar sus controles. & La vista cargó y mostró ``POSTGRESQL CONECTADO'', el área de carga y la validación previa. & OK\\
\addlinespace
FEL-02 & FEL & SIS & Consulta histórica & -- & Presionar ``Mostrar datos cargados''. & Debe aparecer el catálogo histórico. & El control permaneció visible, pero no apareció un catálogo adicional. & No OK\\
\addlinespace
FEL-03 & FEL & SIS & Carga de archivo & Archivo FEL no disponible & Seleccionar un archivo CSV, XLS o XLSX de hasta 15 MB. & El archivo debe pasar a procesamiento. & No se completó porque no había un archivo FEL de prueba disponible. & No ejecutado\\
\addlinespace
FEL-04 & FEL & SIS & Validaciones previas & -- & Revisar el bloque de validación antes del procesamiento. & Deben validarse receptor, NIT, autorización, IVA y duplicados. & Las validaciones se muestran en la interfaz, pero no se comprobaron con un archivo real. & No OK\\
\end{xltabular}}
...
\bottomrule
\endlastfoot
PROV-01 & Prov. & SIS & Consulta del directorio & -- & Abrir el módulo y revisar proveedores, estados, crédito, retenciones y cuentas. & El directorio debe mostrar los registros disponibles. & Se visualizaron cuatro proveedores activos con sus condiciones y cuentas contables. & OK\\
\addlinespace
PROV-02 & Prov. & SIS & Modalidad de partida & -- & Cambiar ``Tipo de partida'' a ``Transitoria general''. & Debe cambiar la modalidad de generación. & La interfaz cambió la modalidad y ocultó el selector individual de proveedor. & OK\\
\addlinespace
PROV-03 & Prov. & SIS & Generación de partida & -- & Presionar ``Generar partidas'' en modalidad transitoria. & Debe aparecer una confirmación o una nueva partida. & El botón recibió la interacción, pero no se observó un resultado nuevo verificable. & No OK\\
\end{xltabular}}
...
\bottomrule
\endlastfoot
NOM-01 & Nomen. & SIS & Carga del catálogo & -- & Abrir Nomenclatura y revisar sus indicadores. & Deben cargarse las cuentas y el estado del catálogo. & Se visualizaron 39 cuentas, 4 tipos registrados y estado ``Activo''. & OK\\
\addlinespace
NOM-02 & Nomen. & SIS & Búsqueda por código & Código: 610112 & Ingresar el código 610112 en el buscador. & Debe mostrarse la cuenta coincidente. & El catálogo se filtró a ``DEPRECIACIONES Y COMBUSTIBLES'', tipo Gasto, naturaleza Debe y estado Activa. & OK\\
\addlinespace
NOM-03 & Nomen. & SIS & Nueva cuenta & -- & Presionar ``Nueva cuenta''. & Debe abrirse el formulario de registro. & El botón recibió la interacción, pero no apareció un formulario visible. & No OK\\
\end{xltabular}}
